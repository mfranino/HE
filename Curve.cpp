...
// RMS S krivulja
//
unsigned char Curve::cPower[256] __attribute__ ((__progmem__)) = {
...
// linear
//
unsigned char Curve::cElsis[256] __attribute__ ((__progmem__)) = {
...
//linear with preheat
//
unsigned char Curve::cElsisPreheat[256] __attribute__ ((__progmem__)) = {
...
// fluo
//
unsigned char Curve::cFluo[256] __attribute__ ((__progmem__)) = {
...
// direkt
//
unsigned char Curve::cDirect[256] __attribute__ ((__progmem__)) = {
...
const prog_char * Curve::outFuncTable[MAXCURVE] = { (prog_char *)&Curve::cElsis[0],
        (prog_char *)&Curve::cElsisPreheat[0], (prog_char *)&Curve::cFluo[0],
        (prog_char *)&Curve::cFluo[0], (prog_char *)&Curve::cDirect[0] };
...
{
    return ( pgm_read_byte_near( ( unsigned int )
         &outFuncTable[Nvr::setup.outFunc[chn]][val] ));
};
